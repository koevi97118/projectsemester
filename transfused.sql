...
INNER JOIN sofa_respi_day1_to_day4  ON all_reliable.patientunitstayid = sofa_respi_day1_to_day4.patientunitstayid
INNER JOIN sofa_renal_day1_to_day4  ON all_reliable.patientunitstayid = sofa_renal_day1_to_day4.patientunitstayid
...
left join sofaday using(patientunitstayid)
